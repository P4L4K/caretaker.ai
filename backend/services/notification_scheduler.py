...
def _scheduler_loop():
    ...
    # Track which minute-level tasks last ran
    last_expiry_check = None   # Run once per day
    last_report_check = None   # Run once per day
    ...
    while not _stop_event.is_set():
        ...
        # Medication expiry — once per day at startup or first pass of the day
